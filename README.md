# agentops-in-action-workshop

A hands-on AgentOps lab that teaches participants how to evaluate, secure, observe, and operate enterprise AI agents on Red Hat OpenShift AI using runtime controls, identity-aware authorization, automated testing, and policy tuning
...
1. Open in DevSpaces: `https://devspaces.apps.ocpv-infra02.wdc07.infra.demo.redhat.com#https://github.com/rhpds/agentops-in-action-workshop`
...
2. Clone the repo:
   ```
   git clone https://github.com/rhpds/agentops-in-action-workshop
   ```
